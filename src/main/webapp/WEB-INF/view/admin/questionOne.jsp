		            ...
		            <div class="card-body">
		              ...
		              <form method="post" action="${pageContext.request.contextPath}/on/addAnswer" id="addAnswer">
			              ...
			              <table class="table table-bordered">
		             	  ...
		             	  <br>
			              <button type="button" class="btn btn-outline-secondary" id="addAnswerBtn">입력</button>
		              </form>
		              <br>
		              <!-- End Table with stripped rows -->
				      <br>
		          ...
		          <div class="card">
		            <div class="card-body">
		              ...
		              <table class="table table-bordered">
	             	  ...
	             	  <br>
	             	  <a href="${pageContext.request.contextPath}/on/removeAnswer?qNo=${question.qNo}&memberId=${question.memberId}" class="btn btn-outline-secondary">삭제</a>
		              <!-- <button type="button" class="btn btn-outline-secondary" id="addAnswerBtn">삭제</button> -->
		              <br>
		              <!-- End Table with stripped rows -->
				      <br>
		            </div>
