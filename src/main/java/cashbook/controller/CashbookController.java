...
public class CashbookController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (loginInfo instanceof Admin) {
			...
			System.out.println(adminId + " <-- adminId(CashbookGet)");
		...
		// 관리자 정보를 cashbook.jsp로 포워딩	
		request.getRequestDispatcher("/WEB-INF/view/admin/cashbook.jsp").forward(request, response);
